// py-tools 插件自带前端入口（Vue 3）——process（Python）插件加界面的教学示例。
...
// 构建：pnpm build-external-ui plugins/py-tools → ui/index.js + style.css（gitignored）。
...
window.__TB_PLUGIN_UI__["py-tools"] = {
  mount(el, api) {
