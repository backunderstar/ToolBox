...
pub struct TbHostApi {
    ...
    /// 用系统默认应用打开路径（文件/文件夹，Windows 资源管理器）。
    /// 返回 0 成功、非 0 失败（插件转成错误信息）。
    pub open_path: Option<unsafe extern "C" fn(ctx: *mut c_void, path: *const c_char) -> i32>,
}
